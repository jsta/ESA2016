...
\section{Results}
	\subsection{Results}
		...
		\begin{column}{5cm}
			\begin{center}
			\includegraphics[height=6.8cm,keepaspectratio=true]{images/flseagrant_biscayne-blooms.png}\\
			\end{center}
		\end{column}
		\begin{column}{5cm}
			\begin{center}
			\includegraphics[height=6.2cm,keepaspectratio=true]{figures/barnes_chl.png}\\
			\end{center}
		\end{column}
		\end{columns}
